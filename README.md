...
<a href="https://github.com/AbdulAzeemHashmi/Word-Shooter-Game">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=24&pause=1000&color=6BCBFF&center=true&vCenter=true&width=600&lines=Shoot+Letters.+Form+Words.+Score+Big!;370%2C099+Word+Dictionary+Loaded;8+Directional+Word+Detection;Built+in+C%2B%2B17+with+OpenGL+and+GLUT" alt="Typing SVG" />
</a>
...
<img src="https://img.shields.io/github/stars/AbdulAzeemHashmi/Word-Shooter-Game?style=social" alt="stars"/>
<img src="https://img.shields.io/github/forks/AbdulAzeemHashmi/Word-Shooter-Game?style=social" alt="forks"/>
<img src="https://img.shields.io/github/last-commit/AbdulAzeemHashmi/Word-Shooter-Game?color=FF6B6B" alt="last commit"/>
...
| Issue | Solution |
|---|---|
| ❌ "Could not Read the Image Data file" | Ensure `image-data.bin` is in the working directory |
